...
class SVG:
    ...
    lines   = {
              ...
              ("const_-34",   -162,    green,  True,   "ss"),
                      ("line_pb_3_1_1",red,True,"ss"),
                      ("line_pb_4_1_1",green,True,"ss"),
                      ("line_pb_5_1_1",blue,True,"ss"),
                      ("line_pb_6_1_1",green,True,"ss"),
                      ("line_pb_7_1_1",red,True,"ss"),
                      ("line_pb_3_-1_1",red,True,"ss"),
                      ("line_pb_4_-1_1",green,True,"ss"),
                      ("line_pb_5_-1_1",blue,True,"ss"),
                      ("line_pb_6_-1_1",green,True,"ss"),
                      ("line_pb_7_-1_1",red,True,"ss"),
            ...
            "see":[
              ...
              "see2":[
                      ...
                      ("fox",blue,True,"sss"),
                       ...
                       ("nn",        blue, True,   "sss"),
                      ("just",grey,True,"sss"),
              ("const_34",    162,     red,  True,   "sss"),
              ("const_-34",   -162,    green,  True,   "sss"),
                     ],
              "line":[
                       ("km3",        blue, True,   "ss"),
                       ("km2",        green, True,   "ss"),
